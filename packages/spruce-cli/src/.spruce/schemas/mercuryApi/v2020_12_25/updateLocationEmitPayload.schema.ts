...
const updateLocationEmitPayloadSchema: SpruceSchemas.MercuryApi.v2020_12_25.UpdateLocationEmitPayloadSchema = {
		...
		timezone: {
			...
			options: {
				choices: [
					...
					{ value: 'Australia/canberra', label: 'Canberra, Melbourne, Sydney' },
