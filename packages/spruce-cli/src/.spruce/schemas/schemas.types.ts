...
declare module '@sprucelabs/spruce-core-schemas/build/.spruce/schemas/core.schemas.types' {
		...
		interface GetRoleEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				target: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.EventTargetSchema
					}
				}
				/** . */
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.GetRoleEmitPayloadSchema
					}
				}
			}
		}
	...
	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		...
		type MessageTargetEntity = SchemaEntity<SpruceSchemas.MercuryApi.v2020_12_25.MessageTargetSchema>
	}
	...
	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		...
		type MessageSourceEntity = SchemaEntity<SpruceSchemas.MercuryApi.v2020_12_25.MessageSourceSchema>
	}

	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		interface FullMessageChoices {
			value: string

			label: string
		}

		interface FullMessageChoicesSchema extends SpruceSchema.Schema {
		...
		type FullMessageChoicesEntity = SchemaEntity<SpruceSchemas.MercuryApi.v2020_12_25.FullMessageChoicesSchema>
	}
		...
		interface DidMessageEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.DidMessageEmitPayloadSchema
					}
				}
			}
		}
	...
	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		interface Message {
			...
			target: SpruceSchemas.MercuryApi.v2020_12_25.MessageTarget

			source: SpruceSchemas.MercuryApi.v2020_12_25.MessageSource
			...
			choices?:
				| SpruceSchemas.MercuryApi.v2020_12_25.FullMessageChoices[]
				| undefined
				| null
		}
		...
		interface MessageSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				target: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.MessageTargetSchema
					}
				}
				/** . */
				source: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.MessageSourceSchema
					}
				}
				/** . */
				errors: {
				...
				choices: {
					...
					isArray: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.FullMessageChoicesSchema
					}
				}
			}
		}

		type MessageEntity = SchemaEntity<SpruceSchemas.MercuryApi.v2020_12_25.MessageSchema>
	}

	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		interface DidMessageEmitPayload {
			message: SpruceSchemas.MercuryApi.v2020_12_25.Message
		...
		interface DidMessageEmitPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				message: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.MessageSchema
					}
				}
				/** . */
				conversationState: {
	...
	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		interface DidMessageResponsePayload {
			...
			suggestedTopics?:
				| SpruceSchemas.MercuryApi.v2020_12_25.ConversationTopic[]
				| undefined
				| null
		}
		...
		interface DidMessageResponsePayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				suggestedTopics: {
					...
					isArray: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.ConversationTopicSchema
					}
				}
			}
		}
		...
		interface AuthenticateEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.AuthenticateEmitPayloadSchema
					}
				}
			}
		}
		...
		interface AuthenticateResponsePayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				auth: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.AuthSchemaSchema
					}
				}
			}
		}
		...
		interface CanListenEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.CanListenEmitPayloadSchema
					}
				}
			}
		}
		...
		interface ConfirmPinEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.ConfirmPinEmitPayloadSchema
					}
				}
			}
		}
		...
		interface CreateLocationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.CreateLocationEmitPayloadSchema
					}
				}
			}
		}
		...
		interface CreateOrganizationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.CreateOrgEmitPayloadSchema
					}
				}
			}
		}
		...
		interface CreateRoleEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.CreateRoleEmitPayloadSchema
					}
				}
			}
		}
		...
		interface DeleteLocationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.DeleteLocationEmitPayloadSchema
					}
				}
			}
		}
		...
		interface DeleteRoleEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.DeleteRoleEmitPayloadSchema
					}
				}
			}
		}
		...
		interface GetEventContractsResponsePayloadSchema
			...
			fields: {
				...
				contracts: {
					...
					isArray: true
					options: {
						schema: SpruceSchemas.MercuryTypes.v2020_09_01.EventContractSchema
					}
				}
			}
		}
		...
		interface GetLocationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.GetLocationEmitPayloadSchema
					}
				}
			}
		}
		...
		interface GetOrganizationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.GetOrganizationEmitPayloadSchema
					}
				}
			}
		}
		...
		interface GetSkillEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.GetSkillEmitPayloadSchema
					}
				}
			}
		}
	...
	namespace SpruceSchemas.MercuryApi.v2020_12_25 {
		interface HealthResponsePayload {
			skill?:
				| SpruceSchemas.MercuryApi.v2020_12_25.HealthCheckItem
				| undefined
				| null
		...
		interface HealthResponsePayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				skill: {
					type: 'schema'
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.HealthCheckItemSchema
					}
				}
				/** . */
				mercury: {
		...
		interface InstallSkillEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.InstallSkillEmitPayloadSchema
					}
				}
			}
		}
		...
		interface IsSkillInstalledEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.IsSkillInstalledEmitPayloadSchema
					}
				}
			}
		}
		...
		interface ListLocationsEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.ListLocationsEmitPayloadSchema
					}
				}
			}
		}
		...
		interface ListOrganizationsEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.ListOrgsEmitPayloadSchema
					}
				}
			}
		}
		...
		interface ListRolesEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.ListRolesEmitPayloadSchema
					}
				}
			}
		}
		...
		interface RegisterConversationTopicsEmitPayloadSchema
			...
			fields: {
				...
				topics: {
					...
					isArray: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RegisterConversationTopicEmitPayloadTopicSchema
					}
				}
			}
		}
		...
		interface RegisterConversationTopicsEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RegisterConversationTopicsEmitPayloadSchema
					}
				}
			}
		}
		...
		interface RegisterEventsEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RegisterEventsEmitPayloadSchema
					}
				}
			}
		}
		...
		interface RegisterListenersEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RegisterListenersEmitPayloadSchema
					}
				}
			}
		}
		...
		interface RegisterSkillEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RegisterSkillEmitPayloadSchema
					}
				}
			}
		}
		...
		interface RequestPinEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.RequestPinEmitPayloadSchema
					}
				}
			}
		}
		...
		interface UninstallSkillEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UnInstallSkillEmitPayloadSchema
					}
				}
			}
		}
		...
		interface UnregisterEventsEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UnregisterEventsEmitPayloadSchema
					}
				}
			}
		}
		...
		interface UnregisterListenersEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UnregisterListenersEmitPayloadSchema
					}
				}
			}
		}
		...
		interface UpdateLocationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UpdateLocationEmitPayloadSchema
					}
				}
			}
		}
		...
		interface UpdateOrganizationEmitTargetAndPayloadSchema
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UpdateOrgWithoutSlugSchemaSchema
					}
				}
			}
		}
		...
		interface UpdateOrgResponsePayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				organization: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UpdateOrgSchema
					}
				}
			}
		}
		...
		interface UpdateRoleEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				payload: {
					...
					isRequired: true
					options: {
						schema: SpruceSchemas.MercuryApi.v2020_12_25.UpdateRoleEmitPayloadSchema
					}
				}
			}
		}
	...
	namespace SpruceSchemas.SpruceCli.v2020_07_22 {
		...
		interface UpgradeSkillAction {
			/** Upgrade mode. */
			upgradeMode?:
				| ('askEverything' | 'forceEverything' | 'forceRequiredSkipRest')
				| undefined
				| null
		}
		...
		interface UpgradeSkillActionSchema extends SpruceSchema.Schema {
			...
			fields: {
				...
				upgradeMode: {
					...
					options: {
						choices: [
							{ value: 'askEverything'; label: 'Ask for everything' },
	...
	namespace SpruceSchemas.SpruceCli.v2020_07_22 {
		...
		interface InstallSkillAtOrganizationActionSchema
			extends SpruceSchema.Schema {
