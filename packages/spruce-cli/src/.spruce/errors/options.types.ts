...
type ErrorOptions = SchemaErrorOptions | SpruceErrorOptions | TestFailedErrorOptions  | SchemaExistsErrorOptions  | InvalidFeatureCodeErrorOptions  | ExecutingCommandFailedErrorOptions  | NoOrganizationsFoundErrorOptions  | FileExistsErrorOptions  | CreateAutoloaderFailedErrorOptions  | LintFailedErrorOptions  | UserNotFoundErrorOptions  | MercuryResponseErrorErrorOptions  | InvalidTestDirectoryErrorOptions  | DirectoryNotSkillErrorOptions  | GenericErrorOptions  | FeatureNotInstalledErrorOptions  | InvalidCommandErrorOptions  | VscodeNotInstalledErrorOptions  | FailedToImportErrorOptions  | SkillNotRegisteredErrorOptions  | SchemaFailedToImportErrorOptions  | CommandNotImplementedErrorOptions  | NotImplementedErrorOptions  | BootFailedErrorOptions  | BuildFailedErrorOptions  | DirectoryEmptyErrorOptions  | CommandAbortedErrorOptions 
