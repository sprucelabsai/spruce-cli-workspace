...
export interface IFailedToImportPackageJsonDefinition extends FailedToImportPackageJsonDefinition {}

export interface IFailedToImportPackageJsonErrorOptions extends SchemaDefinitionValues<IFailedToImportPackageJsonDefinition>, ISpruceErrorOptions<ErrorCode> {
