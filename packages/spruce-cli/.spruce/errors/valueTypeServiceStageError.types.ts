...
export interface IValueTypeServiceStageErrorDefinition extends ValueTypeServiceStageErrorDefinition {}

export interface IValueTypeServiceStageErrorErrorOptions extends SchemaDefinitionValues<IValueTypeServiceStageErrorDefinition>, ISpruceErrorOptions<ErrorCode> {
