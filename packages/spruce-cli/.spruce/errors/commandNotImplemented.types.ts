...
export interface ICommandNotImplementedDefinition extends CommandNotImplementedDefinition {}

export interface ICommandNotImplementedErrorOptions extends SchemaDefinitionValues<ICommandNotImplementedDefinition>, ISpruceErrorOptions<ErrorCode> {
