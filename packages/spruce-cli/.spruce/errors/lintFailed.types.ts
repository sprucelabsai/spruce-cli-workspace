...
import lintFailedDefinition from '../../src/errors/lintFailed.definition'
...
export interface ILintFailedErrorOptions extends SchemaDefinitionValues<ILintFailedDefinition>, ISpruceErrorOptions<ErrorCode> {
